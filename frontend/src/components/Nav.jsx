...
function Nav() {
  ...
  return (
    <div>
      <div className='w-[100%] h-[70px] fixed top-0 px-[20px] py-[10px] flex items-center justify-between bg-black/90 backdrop-blur-md z-[100] shadow-md'>
      ...
      <div className={`fixed  top-0 w-[100vw] h-[100vh] bg-black/95 backdrop-blur-lg flex items-center justify-center flex-col gap-5 z-[110] ${showHam ? "translate-x-[0%] transition duration-300 ease-in-out" : "translate-x-[-100%] transition duration-300 ease-in-out"}`}>
        <GiSplitCross className='w-[35px] h-[35px] fill-white absolute top-5 right-[4%] cursor-pointer hover:scale-110 transition-transform' onClick={() => setShowHam(prev => !prev)} />
