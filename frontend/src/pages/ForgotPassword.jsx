  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      {step == 1 && <div className="bg-white shadow-md rounded-xl p-8 max-w-md w-full">
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleStep1(); }}>
          <div>
      ...
      {step == 2 && <div className="bg-white shadow-lg rounded-xl p-8 max-w-md w-full">
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleStep2(); }}>
          <div>
            <label className="block text-sm font-medium text-gray-700">
      ...
      {step == 3 && <div className="bg-white shadow-lg rounded-xl p-8 max-w-md w-full">
        ...
        <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); handleStep3(); }}>
          {/* New Password */}
          <div>
